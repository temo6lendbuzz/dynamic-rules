...
public class GreetingsResource {
    ...
    @Operation(summary = "greetings", description = "")
    public GreetingsModelOutput updateModel_greetings(@PathVariable("id") String id, @RequestBody(required = false) @javax.validation.Valid() @javax.validation.constraints.NotNull() GreetingsModelInput resource) {
    ...
    @Operation(summary = "greetings", description = "")
    public GreetingsModelOutput updateModelPartial_greetings(@PathVariable("id") String id, @RequestBody(required = false) @javax.validation.Valid() @javax.validation.constraints.NotNull() GreetingsModelInput resource) {
