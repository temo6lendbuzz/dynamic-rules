 ...
 */
package https_58_47_47kie_46org_47dmn_47__DEB49537_45041E_454FF6_458697_45D934667C4559;
...
@RestController
@RequestMapping("/DMN_262A7D81-06BF-47AB-9712-B4CA4AC96592")
public class DMN__262A7D81_4506BF_4547AB_459712_45B4CA4AC96592Resource {
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(content = @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json", schema = @io.swagger.v3.oas.annotations.media.Schema(ref = "/dmnDefinitions.json#/definitions/InputSetDMN__262A7D81_4506BF_4547AB_459712_45B4CA4AC96592")), description = "DMN input")
    @io.swagger.v3.oas.annotations.responses.ApiResponse(content = @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json", schema = @io.swagger.v3.oas.annotations.media.Schema(ref = "/dmnDefinitions.json#/definitions/OutputSetDMN__262A7D81_4506BF_4547AB_459712_45B4CA4AC96592")), description = "DMN output")
    public ResponseEntity<?> dmn(@RequestBody(required = false) java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://kie.org/dmn/_DEB49537-041E-4FF6-8697-D934667C4559", "DMN_262A7D81-06BF-47AB-9712-B4CA4AC96592");
        org.kie.dmn.api.core.DMNResult decisionResult = decision.evaluateAll(DMNJSONUtils.ctx(decision, variables));
        KogitoDMNResult result = new KogitoDMNResult("https://kie.org/dmn/_DEB49537-041E-4FF6-8697-D934667C4559", "DMN_262A7D81-06BF-47AB-9712-B4CA4AC96592", decisionResult);
    ...
    public String dmn() throws java.io.IOException {
        return new String(org.drools.util.IoUtils.readBytesFromInputStream(this.getClass().getResourceAsStream(org.kie.dmn.feel.codegen.feel11.CodegenStringUtil.escapeIdentifier("DMN_262A7D81-06BF-47AB-9712-B4CA4AC96592") + ".dmn_nologic")));
    }
